    ...
    var body: some View {
        ZStack {
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                Text("No plano Free você possui até **\(freeDailyLimit) check-ins** por dia. Com o Venus Pro, você pode refazer seu check-in quantas vezes quiser e ver previsão emocional de 1, 3 e 7 dias.")
                ...
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    planFeature(text: "Por que da micro-ação com evidências")
                    planFeature(text: "Previsão emocional em 1, 3 e 7 dias")
