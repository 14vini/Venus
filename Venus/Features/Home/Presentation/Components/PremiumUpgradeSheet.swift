    ...
    var body: some View {
        ZStack {
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                Text("No plano Free você pode fazer até **\(freeDailyLimit) check-ins** por dia. Com Venus Pro, seus check-ins são ilimitados e você libera previsão emocional com impacto da micro-ação.")
